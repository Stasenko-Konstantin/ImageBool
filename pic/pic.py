...
def changeBt(bt, row, col, color, zap):
  global mat
  b = list(mat[row])
  b[col] = zap
  st = ""
...
{0}.bind("<Button-1>", lambda event: changeBt({0}, {2}, {3}, "white", "1"))\n\
{0}.bind("<Button-3>", lambda event: changeBt({0}, {2}, {3}, "black", "0"))\n\
